...
velocity or track progress. The speed controller becomes slightly firmer only on
the steep ASCENDING leg, where the fast-changing tangent otherwise dissipates a
small amount of speed at the crown. Gravity compensation remains ascent-only.
Across the curved loop a short tangent look-ahead lets tyre-like steering and
drive force begin turning before track projection advances to the next rapidly
rotated road frame. The look-ahead is modest through the crown and stronger only
