...
and uses a suspension-like normal spring plus a modest constant road-adhesion
load. The stable production target is retained around the crown and exit. Only
on the steep ASCENDING leg does the speed controller become firmer and cancel
the component of gravity opposing travel. That prevents the near-stall observed
around loopT ~= .43 without carrying excess energy into the downhill exit.
