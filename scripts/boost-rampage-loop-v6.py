...
boost marker, and remains force/torque-only. The validated fix keeps the proven
damping and drive gains, removes the experimental direct crown push, and shortens
non-exit loop look-ahead from 0.075*speed to 0.042*speed. This keeps assistance
closer to the current road tangent, preserving the natural inversion/exit line
while maintaining strict physical contact-speed margin. SKY FORGE and DOUBLE
ORBIT are deliberately untouched.
"""
