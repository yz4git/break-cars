...
the crown we damp off-tangent velocity like a loaded tyre. In the lower exit
blend, where the ribbon turns quickly, a mostly perpendicular steering force
rotates the velocity toward the road tangent instead of dissipating its energy.
The exit target still tapers down and overspeed trim remains in force.
