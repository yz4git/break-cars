...
boost marker, and remains force/torque-only. Normal damping and drive gains stay
on the proven values. The only crown rescue is position-scoped: in the short
0.44-0.50 loop phase where the road tangent rotates fastest, drive gain rises
slightly before the measured post-step speed dip occurs. This preserves the
normal trajectory while keeping physical contact speed above the safety margin.
