...
on the proven values. A very small rescue gain is used only if a car has already
fallen below 14 m/s in the narrow crown approach window; this preserves the
