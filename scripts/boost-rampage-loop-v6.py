...
the steep ASCENDING leg and gravity compensation remains ascent-only. Across
the curved loop a short tangent look-ahead lets tyre-like steering and drive
force begin turning before track projection advances to the next rapidly rotated
road frame. Around the crown, the proven damping remains unchanged at normal
speed; only a partially grounded car that has already fallen below 14 m/s gets a
short reduction in off-tangent damping. Fully airborne cars retain the stronger
stabilizing guide. The look-ahead is modest through the crown and stronger only
in the lower exit blend, where the road flattens fastest. Perpendicular steering
rotates velocity instead of dissipating it; the exit target still tapers down
and overspeed trim remains in force.
