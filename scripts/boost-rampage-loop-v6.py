...
velocity toward the road tangent instead of dissipating its energy. Guidance
ends naturally when road.kind stops being loop; there is no artificial cutoff
inside the exit transition. The exit target still tapers down and overspeed trim
remains in force.
