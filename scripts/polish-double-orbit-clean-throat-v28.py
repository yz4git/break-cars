...
DOUBLE ORBIT; start position, timing, physics and all other course geometry
remain untouched.
"""
...
def apply_double_orbit_clean_throat_v28(target: Path) -> None:
    ...
    # track-view's feature spec is the legacy single-loop summary, so use the
    # authoritative selected course id rather than trying to infer loop count.
