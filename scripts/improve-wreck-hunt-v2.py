"""Second-pass Wreck Hunt polish based on rendered iPhone-landscape review."""
...
def patch_physics(path: Path) -> None:
    ...
    text = replace_once(
        text,
        "Object.assign(c,{x:Math.sin(a)*r,z:Math.cos(a)*r,heading:a+Math.PI,vx:0,vz:0,omega:0,hp:c.maxHP",
        "Object.assign(c,{x:Math.sin(a)*r,z:Math.cos(a)*r,heading:a+Math.PI,vx:-Math.sin(a)*4,vz:-Math.cos(a)*4,omega:0,hp:c.maxHP",
